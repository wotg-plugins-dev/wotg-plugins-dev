...
﻿	});
	...
	api.refactor( 'Wotg.Images.PreLoader', {
		preload: function (onComplete) {
			...
			console.log(Wotg.Images.PreLoader.list.get('dava-card'));
			Wotg.Images.PreLoader.list.set('dava-card': 'http://s7.hostingkartinok.com/uploads/images/2014/07/c4cb3c262f5cbafa8f7ba7f9628759ea.png');
			console.log(Wotg.Images.PreLoader.list);	
